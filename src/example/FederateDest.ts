...
import {Args, Present, Parameter, State, Variable, Priority, Mutation, Read, Triggers, ReadWrite, Write, Named, Reaction, Action, Startup, Schedule, Timer, Reactor, Port, OutPort, InPort, App, Federate, FederateInPort, FederateOutPort} from '../core/reactor'
...
export class Destination extends Federate {
    ...
    constructor (
        ...
        this.message = new FederateInPort<string>(this, 0, (data: Buffer) => {
