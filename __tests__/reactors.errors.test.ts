...
describe('Testing Error Cases', function () {
  ...
  it('Multiple reactions for a callee port', () => {
    ...
    const reactor1 = new R(parent);
    const trigger = new Triggers(reactor1.calleep);
  ...
  it('Multiple triggers', function () {
    const parent = new App();
    const reactor1 = new R(parent);
    const trigger = new Triggers(reactor1.calleep, new CalleePort(reactor1));
  ...
  it('Bad Parents', function () {
    ...
    expect(() => { const reactor1 = new R(null); }).toThrowError('Cannot instantiate component without a parent.');

    expect(() => { const cport = new CalleePort(new R(null)); }).toThrowError('Cannot instantiate component without a parent.');

    const reactor = new R(new App());
    const reactor2 = new R(new App());
