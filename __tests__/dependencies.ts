import {
  Reactor, App, Triggers, Args, InPort, type Reaction, type Priority,
  SortableDependencyGraph, type Sortable, PrioritySet, Log, StringUtil
...
describe('Manually constructed simple precedence graphs', () => {
  const graph = new SortableDependencyGraph<Sortable<Priority>>();
  const reactor = new SR(new App());

  const nodes = reactor.getNodes();
...
describe('ReactionQ', () => {
  const graph = new SortableDependencyGraph<Reaction<unknown>>();
  const reactor = new R(new App());
  ...
  const reactionQ = new PrioritySet<Priority>();
  ...
  it('first pop', () => {
    ...
    if (r != null) { expect(r.getPriority()).toEqual(0); }
  });
  ...
  it('second pop', () => {
    ...
    if (r != null) { expect(r.getPriority()).toEqual(100); }
  });
  ...
  it('third pop', () => {
    ...
    if (r != null) { expect(r.getPriority()).toEqual(200); }
  });
  ...
  it('fourth pop', () => {
    ...
    if (r != null) { expect(r.getPriority()).toEqual(300); }
  });
  ...
  it('fifth pop', () => {
    ...
    if (r != null) { expect(r.getPriority()).toEqual(400); }
  });
  ...
  it('sixth pop', () => {
    ...
    if (r != null) { expect(r.getPriority()).toEqual(500); }
  });
