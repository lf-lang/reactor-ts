  ...
  constructor(parent: Reactor | null) {
    ...
    this.addReaction(
      ...
      function (this, a1: Sched<string>) {
        ...
        console.log(
          "Scheduling the overridden action in ScheduleOverriddenAction to trigger RespondToAction"
        );
      }
    );
    ...
    this.addReaction(
      ...
      function (this, a1) {
        a1.schedule(0, "hello");
        console.log(
          "Scheduling the final action in ScheduleAction to trigger RespondToAction"
        );
      }
    );
    ...
    this.addReaction(
      ...
      function (this, a1: Action<string>, a2: Action<string>) {
        ...
        console.log(
          "Response to action is reacting. String payload is: " + msg
        );
      }
    );
  }
