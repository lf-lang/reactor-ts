import { Bank, Reactor, App, Timer, Triggers, Args, type Present, OutPort, InPort, TimeValue, OutMultiPort, Port } from '../src/core/internal';
...
describe('Check bank index', () => {
  class myApp extends App {
    ...
    constructor () {
      ...
      const foo = this.b.port((member) => member.o);
      const bar = [this.b.get(0).o, this.b.get(1).o, this.b.get(2).o];
      it('select port', () => {
